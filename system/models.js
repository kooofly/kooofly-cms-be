...
function createModel(collectionName, fields) {
    ...
    fields.forEach(function(v, i) {
        if(fields.attribute.type === 'ObjectId') {
            fields.attribute.type = Schema.Types.ObjectId
        }
        schemaOption[name] = fields.attribute
    })
...
model('API', {
    ...
    type: { type: String, required: true, default: 'api' }, // api || route
